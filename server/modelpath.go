...
const (
	DefaultRegistry       = "registry.imadam.ai"
...
// modelsDir returns the value of the ADAM_MODELS environment variable or the user's home directory if ADAM_MODELS is not set.
// The models directory is where ADAM stores its model files and manifests.
func modelsDir() (string, error) {
	if models, exists := os.LookupEnv("ADAM_MODELS"); exists {
		return models, nil
	}
	...
	return filepath.Join(home, ".adam", "models"), nil
}

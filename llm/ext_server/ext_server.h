...
// This exposes extern C entrypoints into the moses_server
...
void moses_server_init(ext_server_params_t *sparams, ext_server_resp_t *err);
...
// Caller must call moses_server_release_task_result to free resp->json_resp
...
// Caller must call moses_server_releaes_json_resp to free json_resp if err.id <
// 0

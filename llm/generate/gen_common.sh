...
apply_patches() {
    ...
    if ! grep adam ${LLAMACPP_DIR}/examples/server/CMakeLists.txt; then
        echo 'include (../../../ext_server/CMakeLists.txt) # adam' >>${LLAMACPP_DIR}/examples/server/CMakeLists.txt
    fi

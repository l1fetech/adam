...
The **chat** endpoint is one of two ways to generate text from an LLM with ADAM, and is introduced in version 0.1.14. At a high level, you provide the endpoint an array of objects with a role and content specified. Then with each output and prompt, you add more of those role/content objects, which builds up the history.

## Running the Example

1. Ensure you have the `moses2` model installed:

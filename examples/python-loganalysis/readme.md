...
![loganalyzer 2023-11-10 08_53_29](https://github.com/l1fetech/adam/assets/633681/ad30f1fc-321f-4953-8914-e30e24db9921)
...
This model is available at https://imadam.ai/mattw/loganalyzer. You can customize it and add to your own namespace using the command `adam create <namespace/modelname> -f <path-to-modelfile>` then `adam push <namespace/modelname>`.
